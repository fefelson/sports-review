...
myEVT_TeamStats = NewEventType()
EVT_TeamStats = PyEventBinder(myEVT_TeamStats)

class TeamStatsEvent(PyCommandEvent):
    """
...
class TeamStatsThread(Thread):
    ...
    def run(self):
        ...
        evt = TeamStatsEvent(myEVT_TeamStats, -1, result)
